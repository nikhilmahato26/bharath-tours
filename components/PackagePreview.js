'use client'
import { Clock, MapPin, Tag, Check, CalendarDays } from 'lucide-react'
    ...
    <div style={{ fontSize: 14, color: '#111' }}>
      ...
      {pkg.overview && (
        <div style={{ marginTop: 18 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: '#6b7280', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: 6 }}>Overview</div>
